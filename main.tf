...
module "rds_proxy" {
  ...
  vpc_subnet_ids         = ["subnet-0573a5eb6ce26df41", "subnet-09619065c33d08027"] #module.vpc.private_subnets
  vpc_security_group_ids = ["sg-003566a47b586d4fa"] #[module.rds_proxy_sg.security_group_id]
  ...
  secrets = {
    secret1 = {
      ...
      arn         = data.aws_secretsmanager_secret.by-arn.arn
      kms_key_id  = data.aws_secretsmanager_secret.by-arn.kms_key_id
    }
  }
  ...
  db_cluster_identifier = "postgresql-proxy-db" #module.rds.cluster_id
